...
export async function simulatePrices() {
    // 글로벌 설정 조회 (없으면 기본값 사용) - 최상단에서 조회하여 동결 시 즉시 종료
    ...
    // 변동성 배수가 0이면 시장 동결 상태이므로 모든 연산을 건너뜀 (DB 연산량 절감)
